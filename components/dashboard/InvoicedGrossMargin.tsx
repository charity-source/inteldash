...
const PROJECTS = [
  "Westfield Tower - Fire System Upgrade",
  "Harbour Bridge Residences - Plumbing Fit-out",
  "Meridian Plaza - HVAC Retrofit",
  "Oakridge Estate - Bathroom Renovations",
  "Summit Retail - Sprinkler Installation",
  "Lakewood Village - Water Main Replacement",
  "BridgePoint Commercial - Full Fit-out",
  "Pinnacle Tower - Emergency Works",
];
